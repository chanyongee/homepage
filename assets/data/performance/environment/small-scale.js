export default [
  {
    ...
    body: [
      ...
      ['2022.08.02', '괴산군 청천면 금평리 공장(금평산업)'],
      ...
      ['2022.05.19', '충주시 앙성면 모점리 관광농원 (밤별관광농원)'],
      ...
      ['2019.12.03', '충주시 주덕읍 대곡리 ㈜에스제이환경산업 공장증설'],
      ['2019.11.27', '영천댐 안전성강화사업 건설공사(변경1차)'],
      ['2019.10.16', '충주시 노은면 신효리 김치나라 제2공장 '],
      ...
      ['2018.08.27', '청주시 흥덕구 옥산면 호죽리 초록쉼터 공장'],
      ...
      ['2018.02.01', '청주시 상당구 미원면 용곡리 ㈜보우 광산(규석) 채광계획변경'],
      ...
      ['2016.11.10', '음성군 맹동면 봉현리 ㈜정욱리싸이클링 폐기물에너지화 설비 건설사업'],
      ...
      ['2016.01.12', '음성군 대소면 부윤리 ○도이앤씨㈜ 공장설립'],
